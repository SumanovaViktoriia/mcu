...
void update_display(void)
{
    ...
    ili9341_draw_text(&ili9341_display, 10, 5, "Atmosphere Monitor", &jetbrains_font, COLOR_CYAN, COLOR_BLACK);
    
    ili9341_draw_line(&ili9341_display, 0, 25, 320, 25, COLOR_WHITE);
    
    char buffer[64];
    
    ili9341_draw_text(&ili9341_display, 10, 35, "Temperature:", &jetbrains_font, COLOR_YELLOW, COLOR_BLACK);
    snprintf(buffer, sizeof(buffer), "%.1f C", current_temp);
    ili9341_draw_text(&ili9341_display, 150, 35, buffer, &jetbrains_font, COLOR_WHITE, COLOR_BLACK);
    ...
    ili9341_draw_text(&ili9341_display, 10, 80, "Pressure:", &jetbrains_font, COLOR_YELLOW, COLOR_BLACK);
    snprintf(buffer, sizeof(buffer), "%.1f hPa", current_pres);
    ili9341_draw_text(&ili9341_display, 150, 80, buffer, &jetbrains_font, COLOR_WHITE, COLOR_BLACK);
    draw_gauge(10, 100, 300, 15, current_pres, 980, 1040, COLOR_GREEN);
    
    ili9341_draw_text(&ili9341_display, 10, 125, "Humidity:", &jetbrains_font, COLOR_YELLOW, COLOR_BLACK);
    snprintf(buffer, sizeof(buffer), "%.1f %%", current_hum);
    ili9341_draw_text(&ili9341_display, 150, 125, buffer, &jetbrains_font, COLOR_WHITE, COLOR_BLACK);
    ...
    ili9341_draw_text(&ili9341_display, 10, 175, "Last 60s History", &jetbrains_font, COLOR_CYAN, COLOR_BLACK);
    
    ili9341_draw_text(&ili9341_display, 10, 195, "Temp", &jetbrains_font, COLOR_RED, COLOR_BLACK);
    draw_graph(50, 190, 250, 35, temp_history, history_count, 15, 35, COLOR_RED);
    
    ili9341_draw_text(&ili9341_display, 10, 235, "Hum", &jetbrains_font, COLOR_BLUE, COLOR_BLACK);
...
int main(void)
{
    ...
    ili9341_fill_screen(&ili9341_display, COLOR_BLACK);
    ili9341_draw_text(&ili9341_display, 50, 100, "Atmosphere Monitor", &jetbrains_font, COLOR_CYAN, COLOR_BLACK);
    ili9341_draw_text(&ili9341_display, 80, 130, "Starting...", &jetbrains_font, COLOR_WHITE, COLOR_BLACK);
